...
|---------|-------------|------------------------|
| Utility project | A small, single-purpose object (a container, jig, fixture, or similar) defined as one Python module and manufactured as one part. | Parametric modeling, STEP export |
